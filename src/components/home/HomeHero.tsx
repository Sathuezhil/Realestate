  ...
  return (
    <section className="relative isolate min-h-[92vh] overflow-hidden">
      ...
      >
        ...
        <h1 className="hero-line mt-4 max-w-3xl font-serif text-5xl leading-[1.05] text-ivory md:text-7xl">
          The right <span className="gold-shimmer">Dubai</span> address. Arranged privately.
        </h1>
        <p className="hero-line mt-5 max-w-xl text-base leading-7 text-ivory/85">
          Palm villas, Downtown penthouses, and gated community homes — with a specialist on WhatsApp
          and a viewing, often the same day.
        </p>
        <div className="hero-line mt-6 flex flex-wrap gap-2 text-[11px] uppercase tracking-[0.14em] text-ivory/75">
        ...
        <div className="hero-line mt-5 flex flex-wrap gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-white/25 px-5 py-2.5 text-sm text-ivory"
          >
            <Phone className="h-4 w-4" />
            {STUDIO.phoneDisplay}
          </a>
          <Link href="/listings" className="inline-flex items-center rounded-full px-5 py-2.5 text-sm text-ivory/80 underline-offset-4 hover:underline">
            Browse the collection
          </Link>
        </div>
        <div className="hero-line mt-10">
          <div className="scroll-cue flex flex-col items-start gap-1 text-[11px] uppercase tracking-[0.22em] text-ivory/55">
