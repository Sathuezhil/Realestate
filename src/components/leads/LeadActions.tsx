...
export function TopBanner() {
  return (
    <div className="relative z-50 overflow-hidden bg-ink px-4 py-2 text-center text-[11px] tracking-wide text-ivory sm:text-xs">
      ...
      <span className="mx-2 hidden text-ivory/30 sm:inline">·</span>
